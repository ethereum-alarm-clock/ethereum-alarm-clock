def test_gas_accounting_for_successful_call(unmigrated_chain, web3, deploy_fbc):
    ...
    assert execute_log_data['args']['success'] is True
    ...
    assert abs(recorded_gas_cost - expected_gas_cost) < 1000
