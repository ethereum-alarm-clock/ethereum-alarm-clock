...
def test_middle_third_claim_results_in_no_change(deploy_client,
                                                 deployed_contracts,
                                                 deploy_future_block_call, denoms,
                                                 FutureBlockCall, CallLib,
                                                 SchedulerLib, get_call,
                                                 get_execution_data,
                                                 deploy_coinbase):
    ...
    deploy_client.wait_for_block(call.firstClaimBlock() + 128)
