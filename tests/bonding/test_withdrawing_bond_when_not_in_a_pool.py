...
def test_withdrawing_bond_while_not_in_a_pool(geth_node, geth_coinbase, rpc_client, deployed_contracts):
    ...
    assert alarm.callerBonds.call(geth_coinbase) == 1000 * denoms.ether
    ...
    assert alarm.callerBonds.call(geth_coinbase) == 750 * denoms.ether
    ...
    assert alarm.callerBonds.call(geth_coinbase) == 250 * denoms.ether
