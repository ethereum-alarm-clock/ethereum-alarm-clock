...
def test_int_data_registry(deploy_client, deployed_contracts,
    ...
    assert call.call_data() == '\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xb6i\xfd.'
...
def test_uint_data_registry(deploy_client, deployed_contracts,
    ...
    assert call.call_data() == '\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03\xa0\xc9 u\xc0\xdb\xf3\xb8\xac\xbc_\x96\xce?\n\xd2'
...
def test_address_data_registry(deploy_client,
    ...
    assert call.call_data() == '\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xd3\xcd\xa9\x13\xde\xb6\xf6yg\xb9\x9dg\xac\xdf\xa1q,)6\x01'
...
def test_bytes32_data_registry(deploy_client,
    ...
    assert call.call_data() == 'this is a bytes32 string\x00\x00\x00\x00\x00\x00\x00\x00'
