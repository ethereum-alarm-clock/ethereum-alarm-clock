...
def test_int_data_registry_via_fallback(deploy_client, deployed_contracts,
    ...
    value = -1234567890
    call_data = utils.encode_hex(client_contract.setInt.abi_args_signature([value]))
...
def test_uint_data_registry_via_fallback(deploy_client, deployed_contracts,
                                         deploy_future_block_call):
    client_contract = deployed_contracts.TestCallExecution
    ...
    call_data = utils.encode_hex(client_contract.setUInt.abi_args_signature([value]))
...
def test_address_data_registry_via_fallback(deploy_client, deployed_contracts,
                                            deploy_coinbase,
                                            deploy_future_block_call):
    client_contract = deployed_contracts.TestCallExecution
    ...
    call_data = utils.encode_hex(client_contract.setAddress.abi_args_signature([value]))
...
def test_bytes32_data_registry_via_fallback(deploy_client,
                                                 deployed_contracts,
                                                 deploy_coinbase,
                                                 deploy_future_block_call):
    client_contract = deployed_contracts.TestCallExecution
    ...
    call_data = utils.encode_hex(client_contract.setBytes32.abi_args_signature([value]))
...
def test_bytes_data_registry_via_fallback(deploy_client, deployed_contracts,
                                          deploy_coinbase,
    ...
    value = 'abc'
    call_data = utils.encode_hex(client_contract.setBytes.abi_args_signature([value]))
